...
@Component
public class SavingsFormMapper {

    public SavingsFormForConversion mapToSavingsForm(GenericParentDto memberDto, GenericChildrenDto dependantDto) {
        SavingsFormForConversion data = new SavingsFormForConversion();
